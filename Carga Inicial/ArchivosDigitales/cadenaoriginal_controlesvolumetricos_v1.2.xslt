...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:controlesvolumetricos="http://www.sat.gob.mx/esquemas/controlesvolumetricos">
  ...
  <xsl:template match="controlesvolumetricos:ControlesVolumetricos">
    ...
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@numeroPermisoCRE"/>
    </xsl:call-template>
  ...
  <xsl:template match="controlesvolumetricos:EXI">
    ...
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@claveProducto"/>
    </xsl:call-template>

    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@claveSubProducto"/>
    </xsl:call-template>

    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@composicionOctanajeDeGasolina"/>
    </xsl:call-template>

    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@gasolinaConEtanol"/>
    </xsl:call-template>

    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@composicionDeEtanolEnGasolina"/>
    </xsl:call-template>

    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@otros"/>
    </xsl:call-template>
  ...
  <xsl:template match="controlesvolumetricos:RECDocumentos">
    ...
    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@permisoAlmacenamientoYDistribucion"/>
    </xsl:call-template>
    ...
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@volumenDocumentado"/>
    </xsl:call-template>
	
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@precioCompra"/>
    </xsl:call-template>

    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@permisoTransporte"/>
    </xsl:call-template>
    ...
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@tipoProveedor"/>
    </xsl:call-template>
    ...
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@nombreProveedor"/>
    </xsl:call-template>
    
    <xsl:call-template name="Opcional">
      <xsl:with-param name="valor" select="./@permisoProveedor"/>
    </xsl:call-template>
